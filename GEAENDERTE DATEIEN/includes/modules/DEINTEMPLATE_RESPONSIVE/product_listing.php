 ...
 * @version $Id: product_listing.php for Grundpreis 2023-11-14 17:23:16Z webchills $
 */
        ...
        for ($col = 0, $n = count($column_list); $col < $n; $col++) {
            ...
            switch ($column_list[$col]) {
                ...
                case 'PRODUCT_LIST_PRICE':
                    ...
                    if (!empty($listing->fields['products_base_unit_price']) && $listing->fields['products_base_unit_price']<>0 ) {
	                  $lc_text .= '<br><span class="basepricelist">'.TEXT_PRODUCTS_BASE_UNIT_PRICE . ' ' . $currencies->format(zen_round($listing->fields['products_base_unit_price'],3)).'/'.$listing->fields['products_base_unit'].'</span><br>';
                    }
	                  }
                    $lc_text .= '</div>';
//                    $lc_text .= '<br><br>';
