 ...
 * @version $Id: collect_info.php for Grundpreis 2023-11-04 08:44:50Z webchills $
 */
...
?>
  ...
  <div class="well" style="color: #31708f;background-color: #d9edf7;border-color: #bce8f1;padding: 10px 10px 0 0;">
    ...
    <div class="col-sm-9 col-md-6">
        <?php echo zen_draw_input_field('products_base_unit_price', $pInfo->products_base_unit_price, 'class="form-control"'); ?>&nbsp;&nbsp;<?php echo TEXT_PRODUCTS_BASE_UNIT_PRICE_INFO; ?>
    </div>
  </div>
