 ...
 * @version $Id: tpl_modules_products_all_listing for Grundpreis 2023-11-04 11:11:58Z webchills $
 */
?>
  ...
  if ($products_all_split->number_of_rows > 0) {
    ...
    while (!$products_all->EOF) {
      ...
      if ((PRODUCT_ALL_LIST_PRICE != '0' and zen_get_products_allow_add_to_cart($products_all->fields['products_id']) == 'Y') and zen_check_show_prices() == true) {
        ...
        if (SHOW_BASE_UNIT_PRICE == 1 && zen_not_null($products_all->fields['products_base_unit_price']) && $products_all->fields['products_base_unit_price'] <> 0) {
