 ...
 * @version $Id: main_template_vars.php for Grundpreis 2022-03-08 09:55:36Z webchills $
 */
/*
...
// This should be first line of the script:
    ...
    if ($product_not_found) {
        ...
        $products_base_unit_price = $currencies->display_price($product_info->fields['products_base_unit_price'], zen_get_tax_rate($product_info->fields['products_tax_class_id'])).'/'.$product_info->fields['products_base_unit'];
        // end add base price
